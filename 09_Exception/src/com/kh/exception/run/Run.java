...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - 런타임 에러 : 프로그램 실행 중 발생하는 에러. 문법적으로는 문제가 없는데 발생함.
		 * 		-> 사용자의 잘못일 가능성이 높긴 하지만
		 * 		-> 개발자가 예측 가능한 경우 처리하지 않았을 때
		 * 
		 * - 논리적 에러 : 소스코드상 문제도 없고, 실행했을 때도 문제가 발생하지 않으나 의도와 다르게 동작하는 경우(기획 / 설계 단계의 미스)
		 * 
		 * 예외 : 시스템 에러를 제외한 나머지 컴파일, 런타임, 논리적 에러와 같이 상대적으로 덜 심각한 에러들. 그 중에서도 주로 런타임 에러를 의미함.
		 * 
		 */
